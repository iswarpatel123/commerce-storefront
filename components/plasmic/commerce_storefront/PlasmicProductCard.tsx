...
import Rating from "../../Rating"; // plasmic-import: hOuV2saaIcL3/component
import Price from "../../Price"; // plasmic-import: GXnpW6Jel40k/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: uHQW2pvgnMYkU9Giixod5o/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: Ok4vRYeFQ-fn/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__ny2LO, {
              [sty.freeBoxsmall__ny2LOimO6K]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___43B5, {
            [sty.freeBoxsmall___43B5ImO6K]: hasVariant($state, "small", "small")
          })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__k0Vik)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  colors={"lightGray"}
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__dsMen)}
                />
              ),
