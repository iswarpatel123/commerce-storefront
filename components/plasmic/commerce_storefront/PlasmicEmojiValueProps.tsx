...
import Value from "../../Value"; // plasmic-import: wGf7n0_TwTbh/component
...
import sty from "./PlasmicEmojiValueProps.module.css"; // plasmic-import: IhuOAlaLc203/css

import PlaneIcon from "./icons/PlasmicIcon__Plane"; // plasmic-import: lJIgU4OKWBCR/icon
...
import DocumentIcon from "./icons/PlasmicIcon__Document"; // plasmic-import: ipditjfnXg8w/icon
import LockIcon from "./icons/PlasmicIcon__Lock"; // plasmic-import: hxPHeEuLHT-_/icon
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__k2RZm)}
          >
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button__q6Qpm)}
                  colors={"black"}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg__ejFhU)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value__gJz1)}
              icon={
                <PlaneIcon
                  className={classNames(projectcss.all, sty.svg__rfb04)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button__jdRnV)}
                  colors={"black"}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg__tS3R)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value___7BkQm)}
              icon={
                <DocumentIcon
                  className={classNames(projectcss.all, sty.svg__apBl8)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button__tzLwH)}
                  colors={"black"}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg__tgnDj)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value___18Tol)}
              icon={
                <LockIcon
                  className={classNames(projectcss.all, sty.svg__hPxUo)}
                  role={"img"}
                />
              }
            >
