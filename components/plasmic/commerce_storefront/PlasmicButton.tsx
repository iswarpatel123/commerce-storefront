...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JwPscNc0nKNr/css
  ...
  return (
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootsize_large_showEndIcon]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "size", "large"),
          [sty.rootsize_large_showEndIcon_rounded]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "size", "large") &&
            hasVariant($state, "rounded", "rounded"),
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__gsPk, {
            [sty.freeBoxcolors_white__gsPk7IXl6]: hasVariant(
              $state,
              "colors",
              "white"
            ),
            [sty.freeBoxcolors_white_showStartIcon__gsPk7IXl6PxPw4]:
              hasVariant($state, "colors", "white") &&
              hasVariant($state, "showStartIcon", "showStartIcon"),
            [sty.freeBoxiconOnly__gsPkjK9K5]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__gsPkxY4Eq]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__gsPkPxPw4]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__gsPkquqgm]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__gsPkjxgki]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__li9Ua)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__ieKwF, {
            [sty.freeBoxshowEndIcon__ieKwFxY4Eq]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__ieKwFjxgki]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__hv1Q)}
                    role={"img"}
                  />
                ),
                ...
                className: classNames(sty.slotTargetEndIcon, {
                  ...
                  [sty.slotTargetEndIconcolors_black_size_large_showEndIcon_rounded]:
                    hasVariant($state, "showEndIcon", "showEndIcon") &&
                    hasVariant($state, "colors", "black") &&
                    hasVariant($state, "size", "large") &&
                    hasVariant($state, "rounded", "rounded"),
