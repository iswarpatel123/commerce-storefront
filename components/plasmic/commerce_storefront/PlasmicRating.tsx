...
import sty from "./PlasmicRating.module.css"; // plasmic-import: hOuV2saaIcL3/css
  ...
  return (
    ...
    >
      <PlasmicIcon__
        ...
        className={classNames(projectcss.all, sty.svg__f49Y, {
          [sty.svgrating_five__f49YRogLz]: hasVariant($state, "rating", "five"),
          [sty.svgrating_fourHalf__f49YkoShr]: hasVariant(
            $state,
            "rating",
            "fourHalf"
          ),
          [sty.svgrating_four__f49YJpnTo]: hasVariant($state, "rating", "four"),
          [sty.svgrating_half__f49YgHqXy]: hasVariant($state, "rating", "half"),
          [sty.svgrating_oneHalf__f49YOxu83]: hasVariant(
            $state,
            "rating",
            "oneHalf"
          ),
          [sty.svgrating_one__f49YPvd2]: hasVariant($state, "rating", "one"),
          [sty.svgrating_threeHalf__f49Y2E6Wb]: hasVariant(
            $state,
            "rating",
            "threeHalf"
          ),
          [sty.svgrating_three__f49YoSOm]: hasVariant(
            $state,
            "rating",
            "three"
          ),
          [sty.svgrating_twoHalf__f49Yw9S94]: hasVariant(
            $state,
            "rating",
            "twoHalf"
          ),
          [sty.svgrating_two__f49YHqhMy]: hasVariant($state, "rating", "two")
        })}
        role={"img"}
      />
      ...
      <PlasmicIcon__
        ...
        className={classNames(projectcss.all, sty.svg___5CJpi, {
          [sty.svgrating_five___5CJpiRogLz]: hasVariant(
            $state,
            "rating",
            "five"
          ),
          [sty.svgrating_fourHalf___5CJpikoShr]: hasVariant(
            $state,
            "rating",
            "fourHalf"
          ),
          [sty.svgrating_four___5CJpiJpnTo]: hasVariant(
            $state,
            "rating",
            "four"
          ),
          [sty.svgrating_oneHalf___5CJpiOxu83]: hasVariant(
            $state,
            "rating",
            "oneHalf"
          ),
          [sty.svgrating_threeHalf___5CJpi2E6Wb]: hasVariant(
            $state,
            "rating",
            "threeHalf"
          ),
          [sty.svgrating_three___5CJpioSOm]: hasVariant(
            $state,
            "rating",
            "three"
          ),
          [sty.svgrating_twoHalf___5CJpiW9S94]: hasVariant(
            $state,
            "rating",
            "twoHalf"
          ),
          [sty.svgrating_two___5CJpiHqhMy]: hasVariant($state, "rating", "two")
        })}
        role={"img"}
      />
      ...
      <PlasmicIcon__
        ...
        className={classNames(projectcss.all, sty.svg__j4PzS, {
          [sty.svgrating_five__j4PzSRogLz]: hasVariant(
            $state,
            "rating",
            "five"
          ),
          [sty.svgrating_fourHalf__j4PzSkoShr]: hasVariant(
            $state,
            "rating",
            "fourHalf"
          ),
          [sty.svgrating_four__j4PzSJpnTo]: hasVariant(
            $state,
            "rating",
            "four"
          ),
          [sty.svgrating_threeHalf__j4PzS2E6Wb]: hasVariant(
            $state,
            "rating",
            "threeHalf"
          ),
          [sty.svgrating_three__j4PzSoSOm]: hasVariant(
            $state,
            "rating",
            "three"
          ),
          [sty.svgrating_twoHalf__j4PzSw9S94]: hasVariant(
            $state,
            "rating",
            "twoHalf"
          )
      ...
      <PlasmicIcon__
        ...
        className={classNames(projectcss.all, sty.svg__dMRup, {
          [sty.svgrating_five__dMRupRogLz]: hasVariant(
            $state,
            "rating",
            "five"
          ),
          [sty.svgrating_fourHalf__dMRupkoShr]: hasVariant(
            $state,
            "rating",
            "fourHalf"
          ),
          [sty.svgrating_four__dMRupJpnTo]: hasVariant(
            $state,
            "rating",
            "four"
          ),
          [sty.svgrating_threeHalf__dMRup2E6Wb]: hasVariant(
            $state,
            "rating",
            "threeHalf"
          )
      ...
      <PlasmicIcon__
        ...
        className={classNames(projectcss.all, sty.svg__gupP, {
          [sty.svgrating_five__gupPRogLz]: hasVariant($state, "rating", "five"),
          [sty.svgrating_fourHalf__gupPkoShr]: hasVariant(
            $state,
            "rating",
            "fourHalf"
          )
