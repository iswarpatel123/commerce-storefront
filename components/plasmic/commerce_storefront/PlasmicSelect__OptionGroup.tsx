...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: qRYDxG_nzPHw/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: _pVPrn90J2P_/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__hbF2Z)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__u0Vp)}
              />
            </React.Fragment>
          ),
          value: args.children
