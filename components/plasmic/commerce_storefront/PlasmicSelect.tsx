...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: MkHLE7mJz1HK/component
import Select__Option from "../../Select__Option"; // plasmic-import: 4wjxvubaGOrG/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: qRYDxG_nzPHw/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: _pVPrn90J2P_/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: ELfMIHD2Zpjb/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: JgXIsi2wbPdq/icon
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__qVDl)}
                      value={"value2"}
                    >
                      {"Option 2"}
                    </Select__Option>
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__rbCEd)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
